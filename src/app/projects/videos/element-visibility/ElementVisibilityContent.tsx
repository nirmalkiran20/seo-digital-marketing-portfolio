...
export default function ElementVisibilityContent() {
  return (
...
{/* Back Navigation Home */}
      ...
      >
        <h1 className="inline-block px-3 py-1 
                ...
                backdrop-blur-lg">Element Visibility in GTM</h1>
        <p className="mt-3 text-sm text-neutral-600 dark:text-neutral-300 max-w-lg mx-auto">
          Optimizing Website Engagement: How Element Visibility Tracking Works.
        </p>
      </motion.div>
