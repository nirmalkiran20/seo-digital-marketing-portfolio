...
export default function DataLayerContent() {
  return (
...
{/* Back Navigation Home */}
      ...
      >
        <h1 className="inline-block px-3 py-1 
                ...
                backdrop-blur-lg">Data Layer in GTM</h1>
        <p className="mt-3 text-sm text-neutral-600 dark:text-neutral-300 max-w-lg mx-auto">
          How to Structure Data Layer Objects for Reliable Tag Management.
        </p>
      </motion.div>
